    ...
    createBrowserRouter([
        ...
        },
        {
            ...
            children: [
                ...
                newRoute(paths.dashboard.keycards.path, 'KeycardsRoute', () => import('./routes/dashboard/Access/Keycards')),
                newRoute(paths.dashboard.access_logs.path, 'AccessLogsRoute', () => import('./routes/dashboard/Access/AccessLog')),
                ...
                newRoute(paths.dashboard.videos.path, 'VideosRoute', () => import('./routes/dashboard/videos/VideosRoute')),
                newRoute(paths.dashboard.video.path, 'VideoStreamRoute', () => import('./routes/dashboard/videos/VideoStreamRoute')),
            ]
        },
