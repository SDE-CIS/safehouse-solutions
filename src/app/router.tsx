    ...
    createBrowserRouter([
        ...
        },
        {
            ...
            children: [
                ...
                newRoute(paths.dashboard.video.live.path, 'CamerasRoute', () => import('./routes/dashboard/cameras/cameras')),
                newRoute(paths.dashboard.video.livePreview.path, 'CameraRoute', () => import('./routes/dashboard/cameras/camera')),
