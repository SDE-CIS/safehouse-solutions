    ...
    createBrowserRouter([
        ...
        },
        {
            ...
            children: [
                ...
                newRoute(paths.dashboard.users.path, 'UsersRoute', () => import('./routes/dashboard/User/Users2')),
                newRoute(paths.dashboard.user.path, 'UserRoute', () => import('./routes/dashboard/User/User2')),
